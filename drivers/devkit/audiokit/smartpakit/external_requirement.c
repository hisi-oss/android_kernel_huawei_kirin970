...
struct smartpa_regulator_reg_ops hisi_reg_ops = {
	.spmi_regulator_reg_read = smartpakit_hisi_regulator_reg_read,
	.spmi_regulator_reg_write = smartpakit_hisi_regulator_reg_write,
};
