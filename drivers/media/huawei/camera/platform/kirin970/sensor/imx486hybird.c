...
static struct sensor_power_setting imx486hybird_udp_power_setting [] = {
...
static sensor_t s_imx486hybird_udp =
{
    .intf = { .vtbl = &s_imx486hybird_vtbl, },
    .power_setting_array = {
        .size = ARRAY_SIZE(imx486hybird_udp_power_setting),
        .power_setting = imx486hybird_udp_power_setting,
    },
};
