...
static bool s_ov16885_power_on = false;
...
int ov16885_match_id(hwsensor_intf_t* si, void * data);
...
const struct of_device_id s_ov16885_dt_match[] =
{
    {
...
int32_t ov16885_platform_probe(struct platform_device* pdev)
{
    int rc = 0;
...
int __init
ov16885_init_module(void)
{
    cam_notice("enter %s",__func__);
    return platform_driver_probe(&s_ov16885_driver,
            ov16885_platform_probe);
}

void __exit
ov16885_exit_module(void)
{
    if( NULL != s_sensor)
    {
