...
#define MEM_ISP_RDR_OFFSET (0x6AE000)
...
#define TEXT_BASE (0xC0100000)
#define DATA_BASE (0xC0600000)
#define ISP_TEXT_SIZE (0x00500000)
#define ISP_DATA_SIZE (0x00A00000)
