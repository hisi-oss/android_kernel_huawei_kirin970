...
#endif
#define SYS_AO_CODE_SEC_BASE (LPMCU_DDR_DATA_SEC_BASE + LPMCU_DDR_DATA_SEC_SIZE)
#define SYS_AO_CODE_RESERVED_SIZE (0xE00)
#define SYS_AO_CODE_SEC_SIZE (0x9800 - SYS_AO_CODE_RESERVED_SIZE)
#if ((SYS_AO_CODE_SEC_BASE + SYS_AO_CODE_SEC_SIZE + SYS_AO_CODE_RESERVED_SIZE) > (M3_SRAM_BASE + M3_SRAM_AO_SIZE))
    #pragma message(PRINT_MACRO(SYS_AO_CODE_SEC_BASE + SYS_AO_CODE_SEC_SIZE + SYS_AO_CODE_RESERVED_SIZE))
    #error "lpmcu ao region overflow!!!"
#endif
#define SYS_CODE_SEC_BASE (SYS_AO_CODE_SEC_BASE + SYS_AO_CODE_SEC_SIZE + SYS_AO_CODE_RESERVED_SIZE)
