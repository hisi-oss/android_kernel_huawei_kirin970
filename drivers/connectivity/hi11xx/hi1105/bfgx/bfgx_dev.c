...
void bfgx_uart_baud_rate_set(unsigned long baud_rate)
{
    g_hisi_platform_data.baud_rate = baud_rate;
}

unsigned long bfgx_uart_baud_rate_get(void)
{
    return g_hisi_platform_data.baud_rate;
}
