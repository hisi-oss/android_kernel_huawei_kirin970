...
#define OAL_ENOENT    2   /* No such file or directory */
#define OAL_EINTR     4   /* Interrupted system call */
#define OAL_EIO       5   /* I/O error */
#define OAL_ENOPERMI  6   /* Not hava file permission */
#define OAL_EAGAIN    11  /* Try again */
...
typedef uint8_t oal_bool_enum_uint8;
...
typedef uint8_t oal_traffic_type_enum_uint8;
...
typedef uint8_t oal_switch_enum_uint8;
...
typedef uint32_t err_code_enum_uint32;
...
typedef enum {
    ...
    OAL_ERR_CODE_CONFIG_ARGS_OVER = (OAL_ERR_CODE_CONFIG_BASE + 9),           /* 配置参数解析结束 */

    /* wlan_cfg 模块新增 wal_wlan_cfg_process_entry未注册 */
    OAL_ERR_CODE_CFG_PROCESS_ENTRY_NOT_FOUND = (OAL_ERR_CODE_CONFIG_BASE + 10),      /* 错误码偏移10 */
    /* cfg args analysis occurs error */
    OAL_ERR_CODE_ARGS_ANALYSIS_ERR = (OAL_ERR_CODE_CONFIG_BASE + 11),                /* 错误码偏移11 */
    /* wal_msg_type not assigned valid value */
    OAL_ERR_CODE_WAL_MSG_TYPE_INVALID = (OAL_ERR_CODE_CONFIG_BASE + 12),             /* 错误码偏移12 */
    OAL_ERR_CODE_W4_WKUP_TIMER_ERROR = (OAL_ERR_CODE_CONFIG_BASE + 13),              /* w4 wake up timer error */
    OAL_ERR_CODE_ALG_PROCESS_INFO_NOT_FOUND = (OAL_ERR_CODE_CONFIG_BASE + 14),       /* alg_config_info not found */
    OAL_ERR_CODE_MAC_VAP_NOT_FOUND = (OAL_ERR_CODE_CONFIG_BASE + 15),                /* mac_vap not found */
    /* wlan_alg_cfg sub alg args analysis entry not found */
    OAL_ERR_CODE_SUB_ALG_ANALYSIS_ENTRY_NOT_FOUND = (OAL_ERR_CODE_CONFIG_BASE + 16), /* 错误码偏移16 */
    OAL_ERR_CODE_SUB_ALG_ARGS_INVALID = (OAL_ERR_CODE_CONFIG_BASE + 17),             /* alg_analysis args invalid */
    OAL_ERR_CODE_MSG_TYPE_INVALID = (OAL_ERR_CODE_CONFIG_BASE + 18),                 /* wal msg type invalid */
    OAL_ERR_CODE_CFG_WKUP_TIMEOUT = (OAL_ERR_CODE_CONFIG_BASE + 19),                 /* config wkup timeout */
    OAL_ERR_CODE_CFG_PKT_TYPE_INVALID = (OAL_ERR_CODE_CONFIG_BASE + 20),             /* config pkt type invalid */
    OAL_ERR_CODE_AL_RX_POINTER_INVALID = (OAL_ERR_CODE_CONFIG_BASE + 21),            /* al_rx pointer invalid */
    ...
    /* 收发模块*** */
    OAL_ERR_CODE_TRX_BASE = 30100,
    OAL_ERR_CODE_WRONG_CHANNEL = (OAL_ERR_CODE_TRX_BASE + 0),
    OAL_ERR_CODE_FLOW_CONTROL  = (OAL_ERR_CODE_TRX_BASE + 1),
...
typedef uint32_t oal_err_code_enum_uint32;
...
typedef uint8_t oal_rom_cb_result_enum_uint8;
...
typedef uint8_t oal_fem_lp_state_enum_uint8;
