...
struct _hcc_bus_dev_ {
    ...
    int32_t wlan_irq; /* gpio for wlan transfer */
    int32_t irq_stat; /* 0:enable, 1:disable */
...
extern int32_t hcc_bus_bindcpu(hcc_bus *hi_bus, uint32_t chan, int32_t is_bind, uint8_t is_lowest_load);
