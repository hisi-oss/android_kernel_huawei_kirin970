...
OAL_STATIC void wl_start_vowifi_nat_keep_alive_process_excp(oal_int32 l_ret, oal_uint8 *puc_ip_pkt)
{
    if (l_ret != EOK) {
                                                              ...
                                                              oal_int32 l_len)
{
    ...
    if (puc_ip_pkt != OAL_PTR_NULL) {
        ...
        pst_start_info = (mac_vowifi_nat_keep_alive_start_info_stru *)oal_mem_alloc_m(OAL_MEM_POOL_ID_LOCAL, uc_msg_len,
                                                                                    OAL_TRUE);
    ...
    wl_start_vowifi_nat_keep_alive_process_excp(l_ret, puc_ip_pkt);
    return OAL_SUCC;
