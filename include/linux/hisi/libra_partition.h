...
static const struct partition partition_table_emmc[] = {
    ...
    {PART_FW_DTB,              828 * 1024,   2 * 1024,     EMMC_USER_PART}, /* fw_dtb            2M    p56 */
    {PART_DTBO,                830 * 1024,  24 * 1024,     EMMC_USER_PART}, /* dtoimage         24M    p57 */
    {PART_TRUSTFIRMWARE,       854 * 1024,   2 * 1024,     EMMC_USER_PART}, /* trustfirmware    2M     p58 */
...
static const struct partition partition_table_ufs[] = {
    ...
    {PART_BOOT,                498 * 1024,  40 * 1024,    UFS_PART_3}, /* boot              40M    p43 */
    {PART_RECOVERY,            538 * 1024,  64 * 1024,    UFS_PART_3}, /* recovery          64M    p44 */
    {PART_ERECOVERY,           602 * 1024,  64 * 1024,    UFS_PART_3}, /* erecovery         64M    p45 */
    {PART_METADATA,            666 * 1024,  16 * 1024,    UFS_PART_3}, /* metadata          16M    p46 */
    {PART_RESERVED8,           682 * 1024,  66 * 1024,    UFS_PART_3}, /* reserved8         66M    p47 */
#else
    {PART_ERECOVERY_RAMDISK,   450 * 1024,  32 * 1024,    UFS_PART_3}, /* erecovery_ramdisk 32M    p41 */
    {PART_ERECOVERY_VENDOR,    482 * 1024,  24 * 1024,    UFS_PART_3}, /* erecovery_vendor  24M    p42 */
    {PART_BOOT,                506 * 1024,  32 * 1024,    UFS_PART_3}, /* boot              32M    p43 */
    {PART_RECOVERY,            538 * 1024,  56 * 1024,    UFS_PART_3}, /* recovery          56M    p44 */
    {PART_ERECOVERY,           594 * 1024,  56 * 1024,    UFS_PART_3}, /* erecovery         56M    p45 */
    {PART_METADATA,            650 * 1024,  16 * 1024,    UFS_PART_3}, /* metadata          16M    p46 */
    {PART_RESERVED8,           666 * 1024,  82 * 1024,    UFS_PART_3}, /* reserved8         82M    p47 */
#endif
    {PART_BL2,                 748 * 1024,   4 * 1024,    UFS_PART_3}, /* bl2                 4M    p48 */
    {PART_ENG_SYSTEM,          752 * 1024,  12 * 1024,    UFS_PART_3}, /* eng_system         12M    p49 */
    {PART_RECOVERY_RAMDISK,    764 * 1024,  32 * 1024,    UFS_PART_3}, /* recovery_ramdisk   32M    p50 */
    {PART_RECOVERY_VENDOR,     796 * 1024,  24 * 1024,    UFS_PART_3}, /* recovery_vendor    24M    p51 */
    {PART_FW_DTB,              820 * 1024,   2 * 1024,    UFS_PART_3}, /* fw_dtb              2M    p52 */
    {PART_DTBO,                822 * 1024,  24 * 1024,    UFS_PART_3}, /* dtoimage           24M    p53 */
    {PART_TRUSTFIRMWARE,       846 * 1024,   2 * 1024,    UFS_PART_3}, /* trustfirmware       2M    p54 */
    {PART_MODEM_FW,            848 * 1024,  56 * 1024,    UFS_PART_3}, /* modem_fw           56M    p55 */
    {PART_ENG_VENDOR,          904 * 1024,  12 * 1024,    UFS_PART_3}, /* eng_vendor         12M    p56 */
    {PART_MODEM_PATCH_NV,      916 * 1024,   4 * 1024,    UFS_PART_3}, /* modem_patch_nv      4M    p57 */
